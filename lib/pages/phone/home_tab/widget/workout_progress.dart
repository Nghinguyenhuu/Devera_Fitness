            ...
            LineChartData(
                ...
                lineTouchData: LineTouchData(
                  touchTooltipData: LineTouchTooltipData(
                    getTooltipItems: (listSpot) {
                      return listSpot.map((e) {
                        if (e.barIndex == 0) {
                          var value = listSpot[0].y - listSpot[1].y;
                          return LineTooltipItem('${value}% increase', TextStyle(fontSize: 12, color: AppColors.success),
                              children: [
                                TextSpan(
                                  text: '\nUpper body workout',
