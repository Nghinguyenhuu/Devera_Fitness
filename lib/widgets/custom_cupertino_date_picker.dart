...
class CustomCupertinoDatePicker extends StatefulWidget {
  ...
  final Widget dateSelectionOverlay;
  final Widget monthSelectionOverlay;
  final Widget yearSelectionOverlay;
  final double diameterRatio;
  final Color? backgroundColor;
  final double offAxisFraction;
  final bool useMaginifier;
  final bool visibleYearSelector;
  ...
  const CustomCupertinoDatePicker({
    ...
    this.dateSelectionOverlay = const CupertinoPickerDefaultSelectionOverlay(),
    this.monthSelectionOverlay = const CupertinoPickerDefaultSelectionOverlay(),
    this.yearSelectionOverlay = const CupertinoPickerDefaultSelectionOverlay(),
    this.visibleYearSelector = true,
  }) : super(key: key);
...
class _CustomCupertinoDatePickerState extends State<CustomCupertinoDatePicker> {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Visibility(
            visible: widget.visibleYearSelector,
            child: Expanded(child: _yearSelector())),
      ],
    );
  }
  ...
  Widget _daySelector() {
    return _selector(
        ...
        selectionOverlay: widget.dateSelectionOverlay);
  }
  ...
  Widget _monthSelector() {
    return _selector(
      ...
      selectionOverlay: widget.monthSelectionOverlay,
    );
  }
  ...
  Widget _yearSelector() {
    return _selector(
        ...
        selectionOverlay: widget.yearSelectionOverlay);
  }
